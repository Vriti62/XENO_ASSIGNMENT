  ...
  const fetchDashboardData = async () => {
    ...
    try {
      const customersResponse = await fetch(
        `${process.env.REACT_APP_API_URL}/api/data/customers-count`,
        { credentials: "include" }
      );
      ...
      const ordersResponse = await fetch(
        `${process.env.REACT_APP_API_URL}/api/data/orders-by-date?store=${user.id}&startDate=${dateRange.startDate}&endDate=${dateRange.endDate}`,
        { credentials: "include" }
      );
      ...
      const topCustomersResponse = await fetch(
        `${process.env.REACT_APP_API_URL}/api/data/top-customers?store=${user.id}`,
        { credentials: "include" }
      );
